 ...
 * $Revision:    V2.4.4
 *
 * Project:      RTE Device Configuration for Si91x 2.0 B0 BRD2605A
 * -------------------------------------------------------------------------- */
...
// These macros define GPIO ports generated by PinTool
// to ensure proper mapping and compatibility with the driver.
#define HP        0
#define ULP       4
#define UULP_VBAT 5

#define GPIO_PORT_0       0  // GPIO PORT HP
...
#define RTE_ULP_PORT 0

#define BUTTON_0_GPIO_PIN 2

#define RTE_BUTTON0_PORT   UULP_VBAT
#define RTE_BUTTON0_NUMBER 0
#define RTE_BUTTON0_PIN    (2U)

#define RTE_BUTTON1_PORT   3
...
#define RTE_USART0_IR_TX_PORT HP
...
#define RTE_USART0_IR_RX_PORT HP
...
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_PIN  (7 + GPIO_MAX_PIN)
#define RTE_ULP_UART_TX_MUX  3
#define RTE_ULP_UART_TX_PAD  0
#elif (RTE_ULP_UART_TX_PORT_ID == 1)
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_PIN  (11 + GPIO_MAX_PIN)
#define RTE_ULP_UART_TX_MUX  3
#define RTE_ULP_UART_TX_PAD  0
#elif (RTE_ULP_UART_TX_PORT_ID == 2)
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_PIN  9
#define RTE_ULP_UART_TX_MUX  3
#define RTE_ULP_UART_TX_PAD  4
#elif (RTE_ULP_UART_TX_PORT_ID == 3)
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_PIN  15
#define RTE_ULP_UART_TX_MUX  3
#define RTE_ULP_UART_TX_PAD  8
#elif (RTE_ULP_UART_TX_PORT_ID == 4)
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_PIN  49
#define RTE_ULP_UART_TX_MUX  3
#define RTE_ULP_UART_TX_PAD  13
#else
...
#define RTE_ULP_UART_TX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_TX_MUX  3
#if ((ULP_UART_TX_LOC == 0) || (ULP_UART_TX_LOC == 1))
#define RTE_ULP_UART_TX_PIN (ULP_UART_TX_PIN + GPIO_MAX_PIN)
#define RTE_ULP_UART_TX_PAD 0
#endif
#if (ULP_UART_TX_LOC == 11)
#define RTE_ULP_UART_TX_PIN ULP_UART_TX_PIN
#define RTE_ULP_UART_TX_PAD 4
#endif
#if (ULP_UART_TX_LOC == 12)
#define RTE_ULP_UART_TX_PIN ULP_UART_TX_PIN
#define RTE_ULP_UART_TX_PAD 8
#endif
#if (ULP_UART_TX_LOC == 13)
#define RTE_ULP_UART_TX_PIN ULP_UART_TX_PIN
#define RTE_ULP_UART_TX_PAD 13
#endif
//Pintool data
...
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  (2 + GPIO_MAX_PIN)
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  0
#elif (RTE_ULP_UART_RX_PORT_ID == 1)
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  (6 + GPIO_MAX_PIN)
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  0
#elif (RTE_ULP_UART_RX_PORT_ID == 2)
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  (9 + GPIO_MAX_PIN)
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  0
#elif (RTE_ULP_UART_RX_PORT_ID == 3)
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  8
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  3
#elif (RTE_ULP_UART_RX_PORT_ID == 4)
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  12
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  7
#elif (RTE_ULP_UART_RX_PORT_ID == 5)
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_PIN  47
#define RTE_ULP_UART_RX_MUX  3
#define RTE_ULP_UART_RX_PAD  11
#else
...
#define RTE_ULP_UART_RX_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RX_MUX  3
#if ((ULP_UART_RX_LOC == 2) || (ULP_UART_RX_LOC == 3) || (ULP_UART_RX_LOC == 10))
#define RTE_ULP_UART_RX_PIN (ULP_UART_RX_PIN + GPIO_MAX_PIN)
#define RTE_ULP_UART_RX_PAD 0
#endif
#if (ULP_UART_RX_LOC == 14)
#define RTE_ULP_UART_RX_PIN ULP_UART_RX_PIN
#define RTE_ULP_UART_RX_PAD 3
#endif
#if (ULP_UART_RX_LOC == 15)
#define RTE_ULP_UART_RX_PIN ULP_UART_RX_PIN
#define RTE_ULP_UART_RX_PAD 7
#endif
#if (ULP_UART_RX_LOC == 16)
#define RTE_ULP_UART_RX_PIN ULP_UART_RX_PIN
#define RTE_ULP_UART_RX_PAD 11
#endif
//Pintool data
...
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_PIN  (1 + GPIO_MAX_PIN)
#define RTE_ULP_UART_CTS_MUX  3
#define RTE_ULP_UART_CTS_PAD  0
#elif (RTE_ULP_UART_CTS_PORT_ID == 1)
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_PIN  (8 + GPIO_MAX_PIN)
#define RTE_ULP_UART_CTS_MUX  3
#define RTE_ULP_UART_CTS_PAD  0
#elif (RTE_ULP_UART_CTS_PORT_ID == 2)
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_PIN  7
#define RTE_ULP_UART_CTS_MUX  3
#define RTE_ULP_UART_CTS_PAD  2
#elif (RTE_ULP_UART_CTS_PORT_ID == 3)
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_PIN  11
#define RTE_ULP_UART_CTS_MUX  3
#define RTE_ULP_UART_CTS_PAD  6
#elif (RTE_ULP_UART_CTS_PORT_ID == 4)
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_PIN  46
#define RTE_ULP_UART_CTS_MUX  3
#define RTE_ULP_UART_CTS_PAD  10
#else
...
#define RTE_ULP_UART_CTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_CTS_MUX  3
#if ((ULP_UART_CTS_LOC == 4) || (ULP_UART_CTS_LOC == 5) || (ULP_UART_CTS_LOC == 6))
#define RTE_ULP_UART_CTS_PIN (ULP_UART_CTS_PIN + GPIO_MAX_PIN)
#define RTE_ULP_UART_CTS_PAD 0
#endif
#if (ULP_UART_CTS_LOC == 17)
#define RTE_ULP_UART_CTS_PIN ULP_UART_CTS_PIN
#define RTE_ULP_UART_CTS_PAD 2
#endif
#if (ULP_UART_CTS_LOC == 18)
#define RTE_ULP_UART_CTS_PIN ULP_UART_CTS_PIN
#define RTE_ULP_UART_CTS_PAD 6
#endif
#if (ULP_UART_CTS_LOC == 19)
#define RTE_ULP_UART_CTS_PIN ULP_UART_CTS_PIN
#define RTE_ULP_UART_CTS_PAD 10
#endif
//Pintool data
...
#define RTE_ULP_UART_RTS_PIN  (10 + GPIO_MAX_PIN)
#define RTE_ULP_UART_RTS_MUX  3
#define RTE_ULP_UART_RTS_PAD  0
#elif (RTE_ULP_UART_RTS_PORT_ID == 1)
#define RTE_ULP_UART_RTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RTS_PIN  6
#define RTE_ULP_UART_RTS_MUX  3
#define RTE_ULP_UART_RTS_PAD  1
#elif (RTE_ULP_UART_RTS_PORT_ID == 2)
#define RTE_ULP_UART_RTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RTS_PIN  10
#define RTE_ULP_UART_RTS_MUX  3
#define RTE_ULP_UART_RTS_PAD  5
#elif (RTE_ULP_UART_RTS_PORT_ID == 3)
#define RTE_ULP_UART_RTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RTS_PIN  48
#define RTE_ULP_UART_RTS_MUX  3
#define RTE_ULP_UART_RTS_PAD  12
#else
...
#define RTE_ULP_UART_RTS_PORT RTE_ULP_PORT
#define RTE_ULP_UART_RTS_MUX  3
#if ((ULP_UART_RTS_LOC == 7) || (ULP_UART_RTS_LOC == 8) || (ULP_UART_RTS_LOC == 9))
#define RTE_ULP_UART_RTS_PIN (ULP_UART_RTS_PIN + GPIO_MAX_PIN)
#define RTE_ULP_UART_RTS_PAD 0
#endif
#if (ULP_UART_RTS_LOC == 20)
#define RTE_ULP_UART_RTS_PIN ULP_UART_RTS_PIN
#define RTE_ULP_UART_RTS_PAD 1
#endif
#if (ULP_UART_RTS_LOC == 21)
#define RTE_ULP_UART_RTS_PIN ULP_UART_RTS_PIN
#define RTE_ULP_UART_RTS_PAD 5
#endif
#if (ULP_UART_RTS_LOC == 22)
#define RTE_ULP_UART_RTS_PIN ULP_UART_RTS_PIN
#define RTE_ULP_UART_RTS_PAD 12
#endif
//Pintool data
...
#define RTE_SSI_MASTER_MISO_PORT   HP
...
#define RTE_SSI_MASTER_MOSI_PORT   HP
...
// <o> SSI_MASTER_DATA2 Pin <0=>GPIO_6 <1=>GPIO_29 <2=>GPIO_54
#ifndef SSI_MASTER_DATA2_LOC
#define RTE_SSI_MASTER_DATA2_PORT_ID 1

#if (RTE_SSI_MASTER_DATA2_PORT_ID == 0)
#define RTE_SSI_MASTER_DATA2        1
#define RTE_SSI_MASTER_DATA2_PORT   HP
#define RTE_SSI_MASTER_DATA2_PIN    6
#define RTE_SSI_MASTER_DATA2_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA2_PADSEL 1
#elif (RTE_SSI_MASTER_DATA2_PORT_ID == 1)
#define RTE_SSI_MASTER_DATA2        1
#define RTE_SSI_MASTER_DATA2_PORT   HP
#define RTE_SSI_MASTER_DATA2_PIN    29
#define RTE_SSI_MASTER_DATA2_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA2_PADSEL 0 //NO PAD
#elif (RTE_SSI_MASTER_DATA2_PORT_ID == 2)
#define RTE_SSI_MASTER_DATA2        1
#define RTE_SSI_MASTER_DATA2_PORT   HP
#define RTE_SSI_MASTER_DATA2_PIN    54
#define RTE_SSI_MASTER_DATA2_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA2_PADSEL 18
#else
#error "Invalid SSI_MASTER_DATA2 Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_SSI_MASTER_DATA2      1
#define RTE_SSI_MASTER_DATA2_PORT HP
#define RTE_SSI_MASTER_DATA2_PIN  SSI_MASTER_DATA2_PIN
#define RTE_SSI_MASTER_DATA2_MODE EGPIO_PIN_MUX_MODE3
#if (SSI_MASTER_DATA2_LOC == 16)
#define RTE_SSI_MASTER_DATA2_PADSEL 1
#endif
#if (SSI_MASTER_DATA2_LOC == 17)
#define RTE_SSI_MASTER_DATA2_PADSEL 0 //NO PAD
#endif
#if (SSI_MASTER_DATA2_LOC == 18)
#define RTE_SSI_MASTER_DATA2_PADSEL 18
#endif
//Pintool data
#endif

// <o> SSI_MASTER_DATA3 Pin <0=>GPIO_7 <1=>GPIO_30 <2=>GPIO_55
#ifndef SSI_MASTER_DATA3_LOC
#define RTE_SSI_MASTER_DATA3_PORT_ID 1

#if (RTE_SSI_MASTER_DATA3_PORT_ID == 0)
#define RTE_SSI_MASTER_DATA3        1
#define RTE_SSI_MASTER_DATA3_PORT   HP
#define RTE_SSI_MASTER_DATA3_PIN    7
#define RTE_SSI_MASTER_DATA3_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA3_PADSEL 2
#elif (RTE_SSI_MASTER_DATA3_PORT_ID == 1)
#define RTE_SSI_MASTER_DATA3        1
#define RTE_SSI_MASTER_DATA3_PORT   HP
#define RTE_SSI_MASTER_DATA3_PIN    30
#define RTE_SSI_MASTER_DATA3_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA3_PADSEL 0 //NO PAD
#elif (RTE_SSI_MASTER_DATA3_PORT_ID == 2)
#define RTE_SSI_MASTER_DATA3        1
#define RTE_SSI_MASTER_DATA3_PORT   HP
#define RTE_SSI_MASTER_DATA3_PIN    55
#define RTE_SSI_MASTER_DATA3_MODE   EGPIO_PIN_MUX_MODE3
#define RTE_SSI_MASTER_DATA3_PADSEL 19
#else
#error "Invalid SSI_MASTER_DATA3 Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_SSI_MASTER_DATA3      1
#define RTE_SSI_MASTER_DATA3_PORT HP
#define RTE_SSI_MASTER_DATA3_PIN  SSI_MASTER_DATA3_PIN
#define RTE_SSI_MASTER_DATA3_MODE EGPIO_PIN_MUX_MODE3
#if (SSI_MASTER_DATA3_LOC == 19)
#define RTE_SSI_MASTER_DATA3_PADSEL 2
#endif
#if (SSI_MASTER_DATA3_LOC == 20)
#define RTE_SSI_MASTER_DATA3_PADSEL 0 //NO PAD
#endif
#if (SSI_MASTER_DATA3_LOC == 21)
#define RTE_SSI_MASTER_DATA3_PADSEL 19
#endif
//Pintool data
#endif
...
#define RTE_SSI_MASTER_SCK_PORT   HP
...
#define RTE_SSI_SLAVE_MISO_PORT   HP
...
#define RTE_SSI_SLAVE_MOSI_PORT   HP
...
#define RTE_SSI_SLAVE_SCK_PORT   HP
...
#define RTE_SSI_SLAVE_CS_PORT   HP
...
#define RTE_SSI_ULP_MASTER_MISO_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MISO_PIN    (2 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MISO_PORT_ID == 1)
#define RTE_SSI_ULP_MASTER_MISO        1
#define RTE_SSI_ULP_MASTER_MISO_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MISO_PIN    (6 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   8
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MISO_PORT_ID == 2)
#define RTE_SSI_ULP_MASTER_MISO        1
#define RTE_SSI_ULP_MASTER_MISO_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MISO_PIN    (9 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MISO_PORT_ID == 3)
#define RTE_SSI_ULP_MASTER_MISO        1
#define RTE_SSI_ULP_MASTER_MISO_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MISO_PIN    8
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 3
#elif (RTE_SSI_ULP_MASTER_MISO_PORT_ID == 4)
#define RTE_SSI_ULP_MASTER_MISO        1
#define RTE_SSI_ULP_MASTER_MISO_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MISO_PIN    47
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 11
#else
...
#define RTE_SSI_ULP_MASTER_MISO      1
#define RTE_SSI_ULP_MASTER_MISO_PORT RTE_ULP_PORT
#if (ULP_SSI_MISO_LOC == 3)
#define RTE_SSI_ULP_MASTER_MISO_PIN    (ULP_SSI_MISO__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   8
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#endif
#if (ULP_SSI_MISO_LOC == 4)
#define RTE_SSI_ULP_MASTER_MISO_PIN    (ULP_SSI_MISO__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#endif
#if (ULP_SSI_MISO_LOC == 12)
#define RTE_SSI_ULP_MASTER_MISO_PIN    (ULP_SSI_MISO__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 0
#endif
#if (ULP_SSI_MISO_LOC == 15)
#define RTE_SSI_ULP_MASTER_MISO_PIN    ULP_SSI_MISO__PIN
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 3
#endif
#if (ULP_SSI_MISO_LOC == 16)
#define RTE_SSI_ULP_MASTER_MISO_PIN    ULP_SSI_MISO__PIN
#define RTE_SSI_ULP_MASTER_MISO_MODE   1
#define RTE_SSI_ULP_MASTER_MISO_PADSEL 11
#endif
...
#define RTE_SSI_ULP_MASTER_MOSI_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (1 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MOSI_PORT_ID == 1)
#define RTE_SSI_ULP_MASTER_MOSI        1
#define RTE_SSI_ULP_MASTER_MOSI_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (5 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   8
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MOSI_PORT_ID == 2)
#define RTE_SSI_ULP_MASTER_MOSI        1
#define RTE_SSI_ULP_MASTER_MOSI_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (11 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_MOSI_PORT_ID == 3)
#define RTE_SSI_ULP_MASTER_MOSI        1
#define RTE_SSI_ULP_MASTER_MOSI_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MOSI_PIN    7
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 2
#elif (RTE_SSI_ULP_MASTER_MOSI_PORT_ID == 4)
#define RTE_SSI_ULP_MASTER_MOSI        1
#define RTE_SSI_ULP_MASTER_MOSI_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_MOSI_PIN    49
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 13
#else
...
#define RTE_SSI_ULP_MASTER_MOSI      1
#define RTE_SSI_ULP_MASTER_MOSI_PORT RTE_ULP_PORT
#if (ULP_SSI_MOSI_LOC == 0)
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (ULP_SSI_MOSI__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#endif
#if (ULP_SSI_MOSI_LOC == 1)
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (ULP_SSI_MOSI__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   8
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#endif
#if (ULP_SSI_MOSI_LOC == 2)
#define RTE_SSI_ULP_MASTER_MOSI_PIN    (ULP_SSI_MOSI__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 0
#endif
#if (ULP_SSI_MOSI_LOC == 13)
#define RTE_SSI_ULP_MASTER_MOSI_PIN    ULP_SSI_MOSI__PIN
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 2
#endif
#if (ULP_SSI_MOSI_LOC == 14)
#define RTE_SSI_ULP_MASTER_MOSI_PIN    ULP_SSI_MOSI__PIN
#define RTE_SSI_ULP_MASTER_MOSI_MODE   1
#define RTE_SSI_ULP_MASTER_MOSI_PADSEL 13
#endif
...
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
#define RTE_SSI_ULP_MASTER_SCK_PORT_ID 3
#else
#define RTE_SSI_ULP_MASTER_SCK_PORT_ID 3
#endif
...
#define RTE_SSI_ULP_MASTER_SCK_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_SCK_PIN    (0 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_SCK_PORT_ID == 2)
#define RTE_SSI_ULP_MASTER_SCK        1
#define RTE_SSI_ULP_MASTER_SCK_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_SCK_PIN    (4 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   8
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_SCK_PORT_ID == 3)
#define RTE_SSI_ULP_MASTER_SCK        1
#define RTE_SSI_ULP_MASTER_SCK_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_SCK_PIN    (8 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_SCK_PORT_ID == 4)
#define RTE_SSI_ULP_MASTER_SCK        1
#define RTE_SSI_ULP_MASTER_SCK_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_SCK_PIN    6
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 1
#elif (RTE_SSI_ULP_MASTER_SCK_PORT_ID == 5)
#define RTE_SSI_ULP_MASTER_SCK        1
#define RTE_SSI_ULP_MASTER_SCK_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_SCK_PIN    46
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 10
#else
...
#define RTE_SSI_ULP_MASTER_SCK      1
#define RTE_SSI_ULP_MASTER_SCK_PORT RTE_ULP_PORT
#if (ULP_SSI_SCK_LOC == 5)
#define RTE_SSI_ULP_MASTER_SCK_PIN    (ULP_SSI_SCK__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#endif
#if (ULP_SSI_SCK_LOC == 6)
#define RTE_SSI_ULP_MASTER_SCK_PIN    (ULP_SSI_SCK__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   8
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#endif
#if (ULP_SSI_SCK_LOC == 7)
#define RTE_SSI_ULP_MASTER_SCK_PIN    (ULP_SSI_SCK__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 0
#endif
#if (ULP_SSI_SCK_LOC == 17)
#define RTE_SSI_ULP_MASTER_SCK_PIN    ULP_SSI_SCK__PIN
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 1
#endif
#if (ULP_SSI_SCK_LOC == 18)
#define RTE_SSI_ULP_MASTER_SCK_PIN    ULP_SSI_SCK__PIN
#define RTE_SSI_ULP_MASTER_SCK_MODE   1
#define RTE_SSI_ULP_MASTER_SCK_PADSEL 10
#endif
...
#define RTE_SSI_ULP_MASTER_CS0_PORT_ID 2
#if (RTE_SSI_ULP_MASTER_CS0_PORT_ID == 0)
#define RTE_SSI_ULP_MASTER_CS0        ULP_SSI_CS0
#define RTE_SSI_ULP_MASTER_CS0_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS0_PIN    (3 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS0_MODE   1
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_CS0_PORT_ID == 1)
#define RTE_SSI_ULP_MASTER_CS0        ULP_SSI_CS0
#define RTE_SSI_ULP_MASTER_CS0_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS0_PIN    (7 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS0_MODE   8
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_CS0_PORT_ID == 2)
#define RTE_SSI_ULP_MASTER_CS0        ULP_SSI_CS0
#define RTE_SSI_ULP_MASTER_CS0_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS0_PIN    (10 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS0_MODE   1
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_CS0_PORT_ID == 3)
#define RTE_SSI_ULP_MASTER_CS0        ULP_SSI_CS0
#define RTE_SSI_ULP_MASTER_CS0_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS0_PIN    48
#define RTE_SSI_ULP_MASTER_CS0_MODE   1
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 12
#else
#error "Change RTE_SSI_ULP_MASTER_CS_PORT_ID other than  '1' or'3' as per PACKAGE_TYPE"
#endif
#else
//Pintool data
#define RTE_SSI_ULP_MASTER_CS0      1
#define RTE_SSI_ULP_MASTER_CS0_PORT RTE_ULP_PORT
#if (ULP_SSI_CS0_LOC == 8)
#define RTE_SSI_ULP_MASTER_CS0_PIN    (ULP_SSI_CS0__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS0_MODE   8
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 0
#endif
#if (ULP_SSI_CS0_LOC == 9)
#define RTE_SSI_ULP_MASTER_CS0_PIN    (ULP_SSI_CS0__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS0_MODE   1
#define RTE_SSI_ULP_MASTER_CS0_PADSEL 0
#endif
#if (ULP_SSI_CS0_LOC == 19)
...
#if (RTE_SSI_ULP_MASTER_CS1_PORT_ID == 0)
#define RTE_SSI_ULP_MASTER_CS1        ULP_SSI_CS1
#define RTE_SSI_ULP_MASTER_CS1_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS1_PIN    (4 + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS1_PADSEL 0
#elif (RTE_SSI_ULP_MASTER_CS1_PORT_ID == 1)
#define RTE_SSI_ULP_MASTER_CS1        ULP_SSI_CS1
#define RTE_SSI_ULP_MASTER_CS1_PORT   RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS1_PIN    10
#define RTE_SSI_ULP_MASTER_CS1_PADSEL 5
#else
#error "Invalid SSI_ULP_CS1 Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_SSI_ULP_MASTER_CS1_PORT RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS1      1
#if (ULP_SSI_CS1_LOC == 10)
#define RTE_SSI_ULP_MASTER_CS1_PIN    (ULP_SSI_CS1__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS1_PADSEL 0
#endif
#if (ULP_SSI_CS1_LOC == 20)
...
#define RTE_SSI_ULP_MASTER_CS2_PORT_ID 0
#if (RTE_SSI_ULP_MASTER_CS2_PORT_ID == 0)
...
#define RTE_SSI_ULP_MASTER_CS2_PADSEL 7
#else
#error "Invalid SSI_ULP_CS2 Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_SSI_ULP_MASTER_CS2_PORT RTE_ULP_PORT
#define RTE_SSI_ULP_MASTER_CS2      1
#if (ULP_SSI_CS2_LOC == 11)
#define RTE_SSI_ULP_MASTER_CS2_PIN    (ULP_SSI_CS2__PIN + GPIO_MAX_PIN)
#define RTE_SSI_ULP_MASTER_CS2_PADSEL 0
#endif
#if (ULP_SSI_CS2_LOC == 21)
...
#define RTE_I2S0_SCLK_PORT_ID 2

#if (RTE_I2S0_SCLK_PORT_ID == 0)
#define RTE_I2S0_SCLK_PORT HP
...
#define RTE_I2S0_WSCLK_PORT_ID 2

#if (RTE_I2S0_WSCLK_PORT_ID == 0)
#define RTE_I2S0_WSCLK_PORT HP
...
#define RTE_I2S0_DIN0_PORT_ID 2

#if (RTE_I2S0_DIN0_PORT_ID == 0)
#define RTE_I2S0_DIN0_PORT HP
...
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_PIN  (3 + GPIO_MAX_PIN)
#define RTE_I2S1_SCLK_MUX  2
#define RTE_I2S1_SCLK_PAD  0
#elif (RTE_I2S1_SCLK_PORT_ID == 1)
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_PIN  (7 + GPIO_MAX_PIN)
#define RTE_I2S1_SCLK_MUX  2
#define RTE_I2S1_SCLK_PAD  0
#elif (RTE_I2S1_SCLK_PORT_ID == 2)
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_PIN  (8 + GPIO_MAX_PIN)
#define RTE_I2S1_SCLK_MUX  2
#define RTE_I2S1_SCLK_PAD  0
#elif (RTE_I2S1_SCLK_PORT_ID == 3)
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_PIN  15
#define RTE_I2S1_SCLK_MUX  2
#define RTE_I2S1_SCLK_PAD  8
#elif (RTE_I2S1_SCLK_PORT_ID == 4)
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_PIN  46
#define RTE_I2S1_SCLK_MUX  2
#define RTE_I2S1_SCLK_PAD  10
#else
...
#define RTE_I2S1_SCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_SCLK_MUX  2
#if ((ULP_I2S_SCLK_LOC == 0) || (ULP_I2S_SCLK_LOC == 1))
#define RTE_I2S1_SCLK_PIN (ULP_I2S_SCLK_PIN + GPIO_MAX_PIN)
#define RTE_I2S1_SCLK_PAD 0
#endif
#if (ULP_I2S_SCLK_LOC == 10)
#define RTE_I2S1_SCLK_PIN ULP_I2S_SCLK_PIN
#define RTE_I2S1_SCLK_PAD 8
#endif
#if (ULP_I2S_SCLK_LOC == 11)
#define RTE_I2S1_SCLK_PIN ULP_I2S_SCLK_PIN
#define RTE_I2S1_SCLK_PAD 10
#endif
//Pintool data
...
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_PIN  (2 + GPIO_MAX_PIN)
#define RTE_I2S1_WSCLK_MUX  2
#define RTE_I2S1_WSCLK_PAD  0
#elif (RTE_I2S1_WSCLK_PORT_ID == 1)
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_PIN  (10 + GPIO_MAX_PIN)
#define RTE_I2S1_WSCLK_MUX  2
#define RTE_I2S1_WSCLK_PAD  0
#elif (RTE_I2S1_WSCLK_PORT_ID == 2)
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_PIN  8
#define RTE_I2S1_WSCLK_MUX  2
#define RTE_I2S1_WSCLK_PAD  3
#elif (RTE_I2S1_WSCLK_PORT_ID == 3)
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_PIN  10
#define RTE_I2S1_WSCLK_MUX  2
#define RTE_I2S1_WSCLK_PAD  5
#elif (RTE_I2S1_WSCLK_PORT_ID == 4)
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_PIN  48
#define RTE_I2S1_WSCLK_MUX  2
#define RTE_I2S1_WSCLK_PAD  12
#else
...
#define RTE_I2S1_WSCLK_PORT RTE_ULP_PORT
#define RTE_I2S1_WSCLK_MUX  2
#if ((ULP_I2S_WSCLK_LOC == 2) || (ULP_I2S_WSCLK_LOC == 3))
#define RTE_I2S1_WSCLK_PIN (ULP_I2S_WSCLK_PIN + GPIO_MAX_PIN)
#define RTE_I2S1_WSCLK_PAD 0
#endif
#if (ULP_I2S_WSCLK_LOC == 12)
#define RTE_I2S1_WSCLK_PIN ULP_I2S_WSCLK_PIN
#define RTE_I2S1_WSCLK_PAD 3
#endif
#if (ULP_I2S_WSCLK_LOC == 13)
#define RTE_I2S1_WSCLK_PIN ULP_I2S_WSCLK_PIN
#define RTE_I2S1_WSCLK_PAD 5
#endif
#if (ULP_I2S_WSCLK_LOC == 14)
#define RTE_I2S1_WSCLK_PIN ULP_I2S_WSCLK_PIN
#define RTE_I2S1_WSCLK_PAD 12
#endif
//Pintool data
...
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_PIN  (1 + GPIO_MAX_PIN)
#define RTE_I2S1_DOUT0_MUX  2
#define RTE_I2S1_DOUT0_PAD  0
#elif (RTE_I2S1_DOUT0_PORT_ID == 1)
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_PIN  (11 + GPIO_MAX_PIN)
#define RTE_I2S1_DOUT0_MUX  2
#define RTE_I2S1_DOUT0_PAD  0
#elif (RTE_I2S1_DOUT0_PORT_ID == 2)
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_PIN  7
#define RTE_I2S1_DOUT0_MUX  2
#define RTE_I2S1_DOUT0_PAD  2
#elif (RTE_I2S1_DOUT0_PORT_ID == 3)
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_PIN  11
#define RTE_I2S1_DOUT0_MUX  2
#define RTE_I2S1_DOUT0_PAD  6
#elif (RTE_I2S1_DOUT0_PORT_ID == 4)
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_PIN  49
#define RTE_I2S1_DOUT0_MUX  2
#define RTE_I2S1_DOUT0_PAD  13
#else
...
#define RTE_I2S1_DOUT0_PORT RTE_ULP_PORT
#define RTE_I2S1_DOUT0_MUX  2
#if ((ULP_I2S_DOUT0_LOC == 4) || (ULP_I2S_DOUT0_LOC == 5) || (ULP_I2S_DOUT0_LOC == 6))
#define RTE_I2S1_DOUT0_PIN (ULP_I2S_DOUT0_PIN + GPIO_MAX_PIN)
#define RTE_I2S1_DOUT0_PAD 0
#endif
#if (ULP_I2S_DOUT0_LOC == 15)
#define RTE_I2S1_DOUT0_PIN ULP_I2S_DOUT0_PIN
#define RTE_I2S1_DOUT0_PAD 2
#endif
#if (ULP_I2S_DOUT0_LOC == 16)
#define RTE_I2S1_DOUT0_PIN ULP_I2S_DOUT0_PIN
#define RTE_I2S1_DOUT0_PAD 6
#endif
#if (ULP_I2S_DOUT0_LOC == 17)
#define RTE_I2S1_DOUT0_PIN ULP_I2S_DOUT0_PIN
#define RTE_I2S1_DOUT0_PAD 13
#endif
//Pintool data
...
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_PIN  (0 + GPIO_MAX_PIN)
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  0
#elif (RTE_I2S1_DIN0_PORT_ID == 1)
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_PIN  (6 + GPIO_MAX_PIN)
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  0
#elif (RTE_I2S1_DIN0_PORT_ID == 2)
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_PIN  (9 + GPIO_MAX_PIN)
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  0
...
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  1
#elif (RTE_I2S1_DIN0_PORT_ID == 4)
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_PIN  12
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  7
#elif (RTE_I2S1_DIN0_PORT_ID == 5)
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_PIN  47
#define RTE_I2S1_DIN0_MUX  2
#define RTE_I2S1_DIN0_PAD  11
#else
...
#define RTE_I2S1_DIN0_PORT RTE_ULP_PORT
#define RTE_I2S1_DIN0_MUX  2
#if ((ULP_I2S_DIN0_LOC == 7) || (ULP_I2S_DIN0_LOC == 8) || (ULP_I2S_DIN0_LOC == 9))
#define RTE_I2S1_DIN0_PIN (ULP_I2S_DIN0_PIN + GPIO_MAX_PIN)
#define RTE_I2S1_DIN0_PAD 0
#endif
#if (ULP_I2S_DIN0_LOC == 18)
#define RTE_I2S1_DIN0_PIN ULP_I2S_DIN0_PIN
#define RTE_I2S1_DIN0_PAD 1
#endif
#if (ULP_I2S_DIN0_LOC == 19)
#define RTE_I2S1_DIN0_PIN ULP_I2S_DIN0_PIN
#define RTE_I2S1_DIN0_PAD 7
#endif
#if (ULP_I2S_DIN0_LOC == 20)
#define RTE_I2S1_DIN0_PIN ULP_I2S_DIN0_PIN
#define RTE_I2S1_DIN0_PAD 11
#endif
//Pintool data
...
#define RTE_I2C0_SCL_PORT    0
#define RTE_I2C0_SCL_PIN     32
#define RTE_I2C0_SCL_MUX     11
#define RTE_I2C0_SCL_PAD     9
#define RTE_I2C0_SCL_I2C_REN 32
#else
#error "Invalid I2C0 RTE_I2C0_SCL Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_I2C0_SCL_PORT HP
#if (I2C0_SCL_LOC == 0)
...
#define RTE_I2C0_SDA_PORT    0
#define RTE_I2C0_SDA_PIN     31
#define RTE_I2C0_SDA_MUX     11
#define RTE_I2C0_SDA_PAD     9
#define RTE_I2C0_SDA_I2C_REN 31
#else
#error "Invalid I2C0 RTE_I2C0_SDA Pin Configuration!"
#endif
#else
//Pintool data
#define RTE_I2C0_SDA_PORT HP
#if (I2C0_SDA_LOC == 3)
...
#define RTE_I2C1_SCL_PORT HP
#define RTE_I2C1_SCL_PIN  33
#define RTE_I2C1_SCL_MUX  11
#define RTE_I2C1_SCL_PAD  9
#define RTE_I2C1_SCL_REN  33
#else
...
#define RTE_I2C1_SDA_PORT HP
#define RTE_I2C1_SDA_PIN  34
#define RTE_I2C1_SDA_MUX  11
#define RTE_I2C1_SDA_PAD  9
#define RTE_I2C1_SDA_REN  34
#else
...
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  (7 + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  7
#define RTE_I2C2_SCL_PAD  0
#elif (RTE_I2C2_SCL_PORT_ID == 1)
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  (8 + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  8
#define RTE_I2C2_SCL_PAD  0
#elif (RTE_I2C2_SCL_PORT_ID == 2)
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  (1 + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_MUX  4
...
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  7
#define RTE_I2C2_SCL_PAD  2
#elif (RTE_I2C2_SCL_PORT_ID == 4)
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  11
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  11
#define RTE_I2C2_SCL_PAD  6
#elif (RTE_I2C2_SCL_PORT_ID == 5)
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  15
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  15
#define RTE_I2C2_SCL_PAD  8
#elif (RTE_I2C2_SCL_PORT_ID == 6)
#define RTE_I2C2_SCL_PORT RTE_ULP_PORT
#define RTE_I2C2_SCL_PIN  46
#define RTE_I2C2_SCL_MUX  4
#define RTE_I2C2_SCL_REN  46
#define RTE_I2C2_SCL_PAD  10
#else
...
#define RTE_I2C2_SCL_PIN (ULP_I2C_SCL_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_REN 1
#define RTE_I2C2_SCL_PAD 0
#endif
#if (ULP_I2C_SCL_LOC == 1)
#define RTE_I2C2_SCL_PIN (ULP_I2C_SCL_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_REN 5
#define RTE_I2C2_SCL_PAD 0
#endif
#if (ULP_I2C_SCL_LOC == 2)
#define RTE_I2C2_SCL_PIN (ULP_I2C_SCL_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_REN 7
#define RTE_I2C2_SCL_PAD 0
#endif
#if (ULP_I2C_SCL_LOC == 3)
#define RTE_I2C2_SCL_PIN (ULP_I2C_SCL_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SCL_REN 8
#define RTE_I2C2_SCL_PAD 0
#endif
#if (ULP_I2C_SCL_LOC == 9)
#define RTE_I2C2_SCL_PIN ULP_I2C_SCL_PIN
#define RTE_I2C2_SCL_REN 7
#define RTE_I2C2_SCL_PAD 2
#endif
#if (ULP_I2C_SCL_LOC == 10)
#define RTE_I2C2_SCL_PIN ULP_I2C_SCL_PIN
#define RTE_I2C2_SCL_REN 11
#define RTE_I2C2_SCL_PAD 6
#endif
#if (ULP_I2C_SCL_LOC == 11)
#define RTE_I2C2_SCL_PIN ULP_I2C_SCL_PIN
#define RTE_I2C2_SCL_REN 15
#define RTE_I2C2_SCL_PAD 8
#endif
#if (ULP_I2C_SCL_LOC == 12)
#define RTE_I2C2_SCL_PIN ULP_I2C_SCL_PIN
#define RTE_I2C2_SCL_REN 46
#define RTE_I2C2_SCL_PAD 10
#endif
...
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  (6 + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  6
#define RTE_I2C2_SDA_PAD  0
#elif (RTE_I2C2_SDA_PORT_ID == 1)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  (9 + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  9
#define RTE_I2C2_SDA_PAD  0
#elif (RTE_I2C2_SDA_PORT_ID == 2)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  (11 + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_MUX  4
...
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  6
#define RTE_I2C2_SDA_PAD  1
#elif (RTE_I2C2_SDA_PORT_ID == 4)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  10
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  10
#define RTE_I2C2_SDA_PAD  5
#elif (RTE_I2C2_SDA_PORT_ID == 5)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  12
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  12
#define RTE_I2C2_SDA_PAD  7
#elif (RTE_I2C2_SDA_PORT_ID == 6)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  47
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  47
#define RTE_I2C2_SDA_PAD  11
#elif (RTE_I2C2_SDA_PORT_ID == 7)
#define RTE_I2C2_SDA_PORT RTE_ULP_PORT
#define RTE_I2C2_SDA_PIN  49
#define RTE_I2C2_SDA_MUX  4
#define RTE_I2C2_SDA_REN  49
#define RTE_I2C2_SDA_PAD  13
#else
...
#define RTE_I2C2_SDA_PIN (ULP_I2C_SDA_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_REN 0
#define RTE_I2C2_SDA_PAD 0
#endif
#if (ULP_I2C_SCL_LOC == 5)
#define RTE_I2C2_SDA_PIN (ULP_I2C_SDA_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_REN 4
#define RTE_I2C2_SDA_PAD 0
#endif
#if (ULP_I2C_SDA_LOC == 6)
#define RTE_I2C2_SDA_PIN (ULP_I2C_SDA_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_REN 0
#define RTE_I2C2_SDA_PAD 0
#endif
#if (ULP_I2C_SDA_LOC == 7)
#define RTE_I2C2_SDA_PIN (ULP_I2C_SDA_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_REN 9
#define RTE_I2C2_SDA_PAD 0
#endif
#if (ULP_I2C_SDA_LOC == 8)
#define RTE_I2C2_SDA_PIN (ULP_I2C_SDA_PIN + GPIO_MAX_PIN)
#define RTE_I2C2_SDA_REN 11
#define RTE_I2C2_SDA_PAD 0
#endif
#if (ULP_I2C_SDA_LOC == 13)
#define RTE_I2C2_SDA_PIN ULP_I2C_SDA_PIN
#define RTE_I2C2_SDA_REN 6
#define RTE_I2C2_SDA_PAD 1
#endif
#if (ULP_I2C_SDA_LOC == 14)
#define RTE_I2C2_SDA_PIN ULP_I2C_SDA_PIN
#define RTE_I2C2_SDA_REN 10
#define RTE_I2C2_SDA_PAD 5
#endif
#if (ULP_I2C_SDA_LOC == 15)
#define RTE_I2C2_SDA_PIN ULP_I2C_SDA_PIN
#define RTE_I2C2_SDA_REN 12
#define RTE_I2C2_SDA_PAD 7
#endif
#if (ULP_I2C_SDA_LOC == 16)
#define RTE_I2C2_SDA_PIN ULP_I2C_SDA_PIN
#define RTE_I2C2_SDA_REN 47
#define RTE_I2C2_SDA_PAD 11
#endif
#if (ULP_I2C_SDA_LOC == 17)
#define RTE_I2C2_SDA_PIN ULP_I2C_SDA_PIN
#define RTE_I2C2_SDA_REN 49
#define RTE_I2C2_SDA_PAD 13
#endif
...
#define RTE_GSPI_MASTER_CLK_PORT HP
...
#define RTE_GSPI_MASTER_CS0_PORT HP
...
#define RTE_GSPI_MASTER_CS1_PORT HP
...
#define RTE_GSPI_MASTER_CS2_PORT HP
...
#define RTE_GSPI_MASTER_MOSI_PORT HP
...
#define RTE_GSPI_MASTER_MISO_PORT HP
...
#define RTE_PWM_1H_PORT HP
#if (PWM_CH0_0H_LOC == 0)
#define RTE_PWM_1H_PIN PWM_CH0_0H_PIN
#define RTE_PWM_1H_MUX 10
#define RTE_PWM_1H_PAD 2
#endif
#if (PWM_CH0_0H_LOC == 1)
#define RTE_PWM_1H_PIN (PWM_CH0_0H_PIN + GPIO_MAX_PIN)
#define RTE_PWM_1H_MUX 8
#define RTE_PWM_1H_PAD 23
#endif
//Pintool data
...
#define RTE_PWM_1L_PORT HP
#if (PWM_CH0_0L_LOC == 2)
#define RTE_PWM_1L_PIN PWM_CH0_0L_PIN
#define RTE_PWM_1L_MUX 10
#define RTE_PWM_1L_PAD 1
#elif (PWM_CH0_0L_LOC == 3)
#define RTE_PWM_1L_PIN (PWM_CH0_0L_PIN + GPIO_MAX_PIN)
...
#define RTE_PWM_2H_PORT HP
#if (PWM_CH1_1H_LOC == 4)
#define RTE_PWM_2H_PIN PWM_CH1_1H_PIN
#define RTE_PWM_2H_MUX 10
#define RTE_PWM_2H_PAD 4
#endif
#if (PWM_CH1_1H_LOC == 5)
#define RTE_PWM_2H_PIN (PWM_CH1_1H_PIN + GPIO_MAX_PIN)
...
#define RTE_PWM_2L_PORT HP
#if (PWM_CH1_1L_LOC == 6)
#define RTE_PWM_2L_PIN PWM_CH1_1L_PIN
#define RTE_PWM_2L_MUX 10
#define RTE_PWM_2L_PAD 3
#endif
#if (PWM_CH1_1L_LOC == 7)
#define RTE_PWM_2L_PIN (PWM_CH1_1L_PIN + GPIO_MAX_PIN)
#define RTE_PWM_2L_MUX 8
#define RTE_PWM_2L_PAD 24
#endif
#if (PWM_CH1_1L_LOC == 8)
...
#define RTE_PWM_3H_PORT HP
#if (PWM_CH2_2H_LOC == 9)
#define RTE_PWM_3H_PIN PWM_CH2_2H_PIN
#define RTE_PWM_3H_MUX 10
#define RTE_PWM_3H_PAD 6
#elif (PWM_CH2_2H_LOC == 10)
#define RTE_PWM_3H_PIN (PWM_CH2_2H_PIN + GPIO_MAX_PIN)
...
//Pintool data
#define RTE_PWM_3L_PORT HP
#if (PWM_CH2_2L_LOC == 11)
#define RTE_PWM_3L_PIN PWM_CH2_2L_PIN
#define RTE_PWM_3L_MUX 10
#define RTE_PWM_3L_PAD 5
#elif (PWM_CH2_2L_LOC == 12)
#define RTE_PWM_3L_PIN (PWM_CH2_2L_PIN + GPIO_MAX_PIN)
...
//Pintool data
#define RTE_PWM_4H_PORT HP
#if (PWM_CH3_3H_LOC == 38)
#define RTE_PWM_4H_PIN PWM_CH3_3H_PIN
#define RTE_PWM_4H_MUX 10
#define RTE_PWM_4H_PAD 8
#elif (PWM_CH3_3H_LOC == 13)
#define RTE_PWM_4H_PIN (PWM_CH3_3H_PIN + GPIO_MAX_PIN)
#define RTE_PWM_4H_MUX 8
#define RTE_PWM_4H_PAD 29
#endif
//Pintool data
...
//Pintool data
#define RTE_PWM_4L_PORT HP
#if (PWM_CH3_3L_LOC == 14)
#define RTE_PWM_4L_PIN PWM_CH3_3L_PIN
#define RTE_PWM_4L_MUX 10
#define RTE_PWM_4L_PAD 7
#endif
#if (PWM_CH3_3L_LOC == 15)
#define RTE_PWM_4L_PIN (PWM_CH3_3L_PIN + GPIO_MAX_PIN)
#define RTE_PWM_4L_MUX 8
#define RTE_PWM_4L_PAD 28
#endif
//Pintool data
...
#define RTE_PWM_SLP_EVENT_TRIG_PORT HP
...
#define RTE_PWM_TMR_EXT_TRIG_1_PORT HP
...
#define RTE_PWM_TMR_EXT_TRIG_2_PORT HP
...
//PWM_TMR_EXT_TRIG_3
//Pintool data
#define RTE_PWM_TMR_EXT_TRIG_3_PORT HP
...
//PWM_TMR_EXT_TRIG_4
//Pintool data
#define RTE_PWM_TMR_EXT_TRIG_4_PORT HP
...
#define RTE_ULP_GPIO_5_PORT ULP
...
#define RTE_ULP_GPIO_6_PORT ULP
...
#define RTE_ULP_GPIO_7_PORT ULP
...
#define RTE_ULP_GPIO_8_PORT ULP
...
#define RTE_ULP_GPIO_9_PORT ULP
...
#define RTE_ULP_GPIO_11_PORT ULP
...
#define RTE_UULP_GPIO_0_PORT UULP_VBAT
...
#define RTE_MEMLCD_CS_PORT HP // Memlcd SPI CS port

#define RTE_MEMLCD_EXTCOMIN_PIN  3  // Memlcd external communication pin
#define RTE_MEMLCD_EXTCOMIN_PORT HP // Memlcd external communication port

#define RTE_MEMLCD_ENABLE_DISPLAY_PIN  0  // Memlcd display enable pin
#define RTE_MEMLCD_ENABLE_DISPLAY_PORT HP // Memlcd display enable port

// GPIO as enable pin for Mic
#define RTE_MIC_ENABLE_PORT RTE_UULP_GPIO_0_PORT
#define RTE_MIC_ENABLE_PIN  RTE_UULP_GPIO_0_PIN

//   <o> UART0_RS485_RE Pin <0=>P0_28 <1=>P0_50 <2=>P0_66 <3=>P0_70  <4=>P0_74
#ifndef USART0_RE_LOC

#define RTE_UART0_RS485_RE_PORT_ID 0
#if (RTE_UART0_RS485_RE_PORT_ID == 0)
#define RTE_UART0_RS485_RE_PIN  28
#define RTE_UART0_RS485_RE_PORT 0
#define RTE_UART0_RS485_RE_MUX  13
#define RTE_UART0_RS485_RE_PAD  0
#elif (RTE_UART0_RS485_RE_PORT_ID == 1)
#define RTE_UART0_RS485_RE_PIN  50
#define RTE_UART0_RS485_RE_PORT 0
#define RTE_UART0_RS485_RE_MUX  2
#define RTE_UART0_RS485_RE_PAD  14
#elif (RTE_UART0_RS485_RE_PORT_ID == 2)
#define RTE_UART0_RS485_RE_PIN  70
#define RTE_UART0_RS485_RE_PORT 0
#define RTE_UART0_RS485_RE_MUX  6
#define RTE_UART0_RS485_RE_PAD  28
#elif (RTE_UART0_RS485_RE_PORT_ID == 3)
#define RTE_UART0_RS485_RE_PIN  74
#define RTE_UART0_RS485_RE_PORT 0
#define RTE_UART0_RS485_RE_MUX  6
#define RTE_UART0_RS485_RE_PAD  32
#else
#error "Invalid UART0_RS485_RE_PIN"
#endif
#else
//Pintool data
#define RTE_UART0_RS485_RE_PORT HP
#if (USART0_RE_LOC == 38)
#define RTE_UART0_RS485_RE_PIN USART0_RS485_RE_PIN
#define RTE_UART0_RS485_RE_MUX 13
#define RTE_UART0_RS485_RE_PAD 0
#endif
#if (USART0_RE_LOC == 39)
...
#endif
#if (USART0_RE_LOC == 40)
#define RTE_UART0_RS485_RE_PIN (USART0_RS485_RE_PIN + GPIO_MAX_PIN)
#define RTE_UART0_RS485_RE_MUX 6
#define RTE_UART0_RS485_RE_PAD 28
#endif
#if (USART0_RE_LOC == 41)
...
// <o> UART0_RS485_DE Pin <0=>P0_29 <1=>P0_51 <2=>P0_67 <3=>P0_71  <4=>P0_75
#ifndef USART0_DE_LOC

#define RTE_UART0_RS485_DE_PORT_ID 1
#if (RTE_UART0_RS485_DE_PORT_ID == 0)
#define RTE_UART0_RS485_DE_PIN  29
#define RTE_UART0_RS485_DE_PORT 0
#define RTE_UART0_RS485_DE_MUX  13
#define RTE_UART0_RS485_DE_PAD  0
#elif (RTE_UART0_RS485_DE_PORT_ID == 1)
#define RTE_UART0_RS485_DE_PIN  51
#define RTE_UART0_RS485_DE_PORT 0
#define RTE_UART0_RS485_DE_MUX  2
#define RTE_UART0_RS485_DE_PAD  15
#elif (RTE_UART0_RS485_DE_PORT_ID == 2)
#define RTE_UART0_RS485_DE_PIN  71
#define RTE_UART0_RS485_DE_PORT 0
#define RTE_UART0_RS485_DE_MUX  6
#define RTE_UART0_RS485_DE_PAD  29
#elif (RTE_UART0_RS485_DE_PORT_ID == 3)
#define RTE_UART0_RS485_DE_PIN  75
#define RTE_UART0_RS485_DE_PORT 0
#define RTE_UART0_RS485_DE_MUX  6
#define RTE_UART0_RS485_DE_PAD  33
#else
#error "Invalid UART0_RS485_DE_PIN"
#endif
#else
//Pintool data
#define RTE_UART0_RS485_DE_PORT HP
#if (USART0_DE_LOC == 42)
#define RTE_UART0_RS485_DE_PIN USART0_RS485_DE_PIN
#define RTE_UART0_RS485_DE_MUX 13
#define RTE_UART0_RS485_DE_PAD 0
#endif
#if (USART0_DE_LOC == 43)
...
#endif
#if (USART0_DE_LOC == 44)
#define RTE_UART0_RS485_DE_PIN (USART0_RS485_DE_PIN + GPIO_MAX_PIN)
#define RTE_UART0_RS485_DE_MUX 6
#define RTE_UART0_RS485_DE_PAD 29
#endif
#if (USART0_DE_LOC == 45)
...
// <o> UART0_RS485_EN Pin <0=>P0_27 <1=>P0_49 <2=>P0_69 <3=>P0_73
#ifndef USART0_EN_LOC

#define RTE_UART0_RS485_EN_PORT_ID 0
#if (RTE_UART0_RS485_EN_PORT_ID == 0)
#define RTE_UART0_RS485_EN_PIN  27
#define RTE_UART0_RS485_EN_PORT 0
#define RTE_UART0_RS485_EN_MUX  13
#define RTE_UART0_RS485_EN_PAD  0
#elif (RTE_UART0_RS485_EN_PORT_ID == 1)
#define RTE_UART0_RS485_EN_PIN  49
#define RTE_UART0_RS485_EN_PORT 0
#define RTE_UART0_RS485_EN_MUX  2
#define RTE_UART0_RS485_EN_PAD  13
#elif (RTE_UART0_RS485_EN_PORT_ID == 2)
#define RTE_UART0_RS485_EN_PIN  69
#define RTE_UART0_RS485_EN_PORT 0
#define RTE_UART0_RS485_EN_MUX  6
#define RTE_UART0_RS485_EN_PAD  27
#elif (RTE_UART0_RS485_EN_PORT_ID == 3)
#define RTE_UART0_RS485_EN_PIN  73
#define RTE_UART0_RS485_EN_PORT 0
#define RTE_UART0_RS485_EN_MUX  6
#define RTE_UART0_RS485_EN_PAD  31
#else
#error "Invalid UART0_RS485_EN_PIN"
#endif
#else
//Pintool data
#define RTE_UART0_RS485_EN_PORT HP
#if (USART0_EN_LOC == 46)
#define RTE_UART0_RS485_EN_PIN USART0_RS485_EN_PIN
#define RTE_UART0_RS485_EN_MUX 13
#define RTE_UART0_RS485_EN_PAD 0
#endif
#if (USART0_EN_LOC == 47)
...
#endif
#if (USART0_EN_LOC == 48)
#define RTE_UART0_RS485_EN_PIN (USART0_RS485_EN_PIN + GPIO_MAX_PIN)
#define RTE_UART0_RS485_EN_MUX 6
#define RTE_UART0_RS485_EN_PAD 27
#endif
#if (USART0_EN_LOC == 49)
...
// <o> UART1_RS485_RE Pin <0=>P0_8 <1=>P0_65 <2=>P0_74
#ifndef UART1_RE_LOC

#define RTE_UART1_RS485_RE_PORT_ID 0
#if (RTE_UART1_RS485_RE_PORT_ID == 0)
#define RTE_UART1_RS485_RE_PIN  8
#define RTE_UART1_RS485_RE_PORT 0
#define RTE_UART1_RS485_RE_MUX  6
#define RTE_UART1_RS485_RE_PAD  3
#elif (RTE_UART1_RS485_RE_PORT_ID == 1)
#define RTE_UART1_RS485_RE_PIN  65
#define RTE_UART1_RS485_RE_PORT 0
#define RTE_UART1_RS485_RE_MUX  6
#define RTE_UART1_RS485_RE_PAD  23
#elif (RTE_UART1_RS485_RE_PORT_ID == 2)
#define RTE_UART1_RS485_RE_PIN  74
#define RTE_UART1_RS485_RE_PORT 0
#define RTE_UART1_RS485_RE_MUX  6
#define RTE_UART1_RS485_RE_PAD  32
#else
#error "Invalid UART1_RS485_RE_PIN"
#endif
#else
//Pintool data
#define RTE_UART1_RS485_RE_PORT HP
#if (UART1_RE_LOC == 26)
#define RTE_UART1_RS485_RE_PIN UART1_RS485_RE_PIN
#define RTE_UART1_RS485_RE_MUX 6
#define RTE_UART1_RS485_RE_PAD 3
#endif
#if (UART1_RE_LOC == 27)
#define RTE_UART1_RS485_RE_PIN (UART1_RS485_RE_PIN + GPIO_MAX_PIN)
#define RTE_UART1_RS485_RE_MUX 6
#define RTE_UART1_RS485_RE_PAD 23
#endif
#if (UART1_RE_LOC == 28)
...
// <o> UART1_RS485_DE Pin <0=>P0_9 <1=>P0_75
#ifndef UART1_DE_LOC

#define RTE_UART1_RS485_DE_PORT_ID 0
#if (RTE_UART1_RS485_DE_PORT_ID == 0)
#define RTE_UART1_RS485_DE_PIN  9
#define RTE_UART1_RS485_DE_PORT 0
#define RTE_UART1_RS485_DE_MUX  6
#define RTE_UART1_RS485_DE_PAD  4
#elif (RTE_UART1_RS485_DE_PORT_ID == 1)
#define RTE_UART1_RS485_DE_PIN  75
#define RTE_UART1_RS485_DE_PORT 0
#define RTE_UART1_RS485_DE_MUX  6
#define RTE_UART1_RS485_DE_PAD  33
#else
#error "Invalid UART1_RS485_DE_PIN"
#endif
#else
//Pintool data
#define RTE_UART1_RS485_DE_PORT HP
#if (UART1_DE_LOC == 29)
#define RTE_UART1_RS485_DE_PIN UART1_RS485_DE_PIN
#define RTE_UART1_RS485_DE_MUX 6
#define RTE_UART1_RS485_DE_PAD 4
#endif
#if (UART1_DE_LOC == 30)
#define RTE_UART1_RS485_DE_PIN (UART1_RS485_DE_PIN + GPIO_MAX_PIN)
#define RTE_UART1_RS485_DE_MUX 6
#define RTE_UART1_RS485_DE_PAD 33
#endif
//Pintool data
...
// <o> UART1_RS485_EN Pin <0=>P0_12 <1=>P0_64
#ifndef UART1_EN_LOC

#define RTE_UART1_RS485_EN_PORT_ID 0
#if (RTE_UART1_RS485_EN_PORT_ID == 0)
#define RTE_UART1_RS485_EN_PIN  12
#define RTE_UART1_RS485_EN_PORT 0
#define RTE_UART1_RS485_EN_MUX  6
#define RTE_UART1_RS485_EN_PAD  7
#elif (RTE_UART1_RS485_EN_PORT_ID == 1)
#define RTE_UART1_RS485_EN_PIN  64
#define RTE_UART1_RS485_EN_PORT 0
#define RTE_UART1_RS485_EN_MUX  6
#define RTE_UART1_RS485_EN_PAD  22
#else
#error "Invalid UART1_RS485_EN_PIN"
#endif
#else
//Pintool data
#define RTE_UART1_RS485_EN_PORT HP
#if (UART1_EN_LOC == 31)
#define RTE_UART1_RS485_EN_PIN UART1_RS485_EN_PIN
#define RTE_UART1_RS485_EN_MUX 6
#define RTE_UART1_RS485_EN_PAD 7
#endif
#if (UART1_EN_LOC == 32)
#define RTE_UART1_RS485_EN_PIN (UART1_RS485_EN_PIN + GPIO_MAX_PIN)
#define RTE_UART1_RS485_EN_MUX 6
#define RTE_UART1_RS485_EN_PAD 22
#endif
//Pintool data
