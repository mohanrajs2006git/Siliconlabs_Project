...
#include "ml/third_party/tflm/non_persistent_arena_buffer_allocator.h"
#include "ml/third_party/tflm/persistent_arena_buffer_allocator.h"
...
#include "ml/third_party/tflm/linear_memory_planner.h"
...
#else
#define NPU_TOOLKIT_RECORD_MEMORY_PLAN(...)
#endif
...
TfLiteStatus MicroAllocator::CommitStaticMemoryPlan(
  ...
  NPU_TOOLKIT_RECORD_MEMORY_PLAN(
    memory_planner_,
    allocation_info,
    allocation_info_count,
    builder.info_.subgraph_offsets
  );
