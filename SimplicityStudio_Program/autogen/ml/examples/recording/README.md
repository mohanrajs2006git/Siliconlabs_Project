...
This demonstrates how to use the model recording utility that comes with the [TfliteMicroModel](npu_toolkit::TfliteMicroModel) API..
...
```shell
 ./npu_toolkit_compiler --platform si91x --accelerator mvpv1 --weights-paging -x codegen.recorder_enabled=1  image_classification.tflite
 ```
...
- `-x codegen.recorder_enabled=1` - Enable the recording utility to be generated 
...
and dump the recorded data to the console.
