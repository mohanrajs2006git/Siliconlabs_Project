...
This builds on the basic example by enabling the logging utility that comes with the [TfliteMicroModel](npu_toolkit::TfliteMicroModel) API.
...
```shell
 ./npu_toolkit_compiler --platform si91x --accelerator mvpv1 --weights-paging -x codegen.logger_enabled=1 image_classification.tflite
 ```
...
- `-x codegen.logger_enabled=1` - Enable the logging utility with the generated code
...
and print to the console logging utility.